...
- **Action:** Add alongside existing `mockDiditResponses`:
  ```typescript
...
- **Action:** Add Didit-specific test cases alongside existing DIDIT tests:
  ...
  - All existing DIDIT tests pass unchanged
...
- [ ] All existing DIDIT tests pass unchanged (no regression)
