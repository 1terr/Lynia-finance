...
Examples:
    python scripts/verify_phone.py send +263771234567
    python scripts/verify_phone.py send +263771234567 --channel whatsapp
    python scripts/verify_phone.py check +263771234567 123456
    python scripts/verify_phone.py check +263771234567 123456 --decline-voip
"""
import argparse
import json
import os
...
def main():
    ...
    send_p.add_argument("phone", help="Phone number in E.164 format (e.g. +263771234567)")
