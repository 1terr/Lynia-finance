...
| **TDD Workflow** | `/tdd`, `/test`, `/coverage`, `/e2e` |
| **Development** | `/implement`, `/refactor`, `/api-design`, `/db-schema` |
| **Code Review** | `/review`, `/pr-review`, `/security-review`, `/perf-review` |
| **DevOps** | `/deploy`, `/rollback`, `/health`, `/incident` |
| **Security** | `/security-audit`, `/threat-model`, `/compliance`, `/pen-test` |
| **Documentation** | `/doc`, `/api-doc`, `/runbook`, `/postmortem` |
