 ...
 *
 * Pure calculation functions for penalty computation, configuration
 * management, waiver processing, and summary queries.
 */
...
import { PenaltyError } from './penalty-types';
...
export async function checkRecurrenceEligibility(
  loanId: string,
  configId: string,
...
export function validatePenaltyConfig(config: Omit<PenaltyConfiguration, 'id'>): void {
