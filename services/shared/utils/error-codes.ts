...
export const ERROR_CODES = {
  ...
  DEV_DUPLICATE_IMEI: 'DEV_DUP_001',
  DEV_IMPORT_FAILED: 'DEV_IMPORT_001',

  // Inventory Transfer Errors (INV_*)
  INV_TRANSFER_NOT_TRANSFERABLE: 'INV_TRANSFER_001',
  INV_TRANSFER_INVALID_TRANSITION: 'INV_TRANSFER_002',
  INV_ADJ_INVALID: 'INV_ADJ_001',

  // Handover Errors (INV_HANDOVER_*)
  INV_HANDOVER_NOT_AVAILABLE: 'INV_HANDOVER_001',
  INV_HANDOVER_IDENTITY_MISMATCH: 'INV_HANDOVER_002',
  INV_HANDOVER_DEPOSIT_NOT_CONFIRMED: 'INV_HANDOVER_003',
  INV_HANDOVER_MODEL_INCOMPATIBLE: 'INV_HANDOVER_004',
